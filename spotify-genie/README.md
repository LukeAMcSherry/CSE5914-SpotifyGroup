...
2. Navigate to our API folder in the terminal and run `docker build -t spotify-genie-api .` 

3. Go to docker images using the gui and "play" the `spotify-genie-api` image.
